...
Once both plugins are installed, you can create the export format **PreisRoboterDE-Plugin**. Refer to the [Exporting data formats for price search engines](https://knowledge.plentymarkets.com/en/basics/data-exchange/exporting-data#30) page of the manual for further details about the individual format settings.
...
| **Typ**                                               | Select the type **Item** from the drop-down menu. |
...
| **Token, URL**                                        | If you selected the option **URL** under **Provisioning**, then click on **Generate token**. The token will be entered automatically. When the token is generated under **Token**, the URL is entered automatically. |
...
| **Market account**                                    | Select the market account from the drop-down menu. The selected referrer is added to the product URL so that sales can be analysed later. |
...
| art_description     | The **description** of the item according to the format setting **Description**. |

...
# Elastic Export PreisRoboter Plugin for plentymarkets 7

This is the elastic export PreisRoboter plugin for plentymarkets 7 which extends the list of possible export formats. 
